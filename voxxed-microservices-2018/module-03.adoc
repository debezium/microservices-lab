...
I.e. not only Kafka Connect sink connectors can be used to consume the events, but you also can do quite easily using a custom Java application and the Kafka consumer API.
